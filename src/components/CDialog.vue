        ...
        >
          <q-toolbar ref="toolbar-header">
            ...
            <q-btn flat round dense icon="info" v-if="regUserInfo.regUserName">
              <q-tooltip anchor="bottom middle" self="top end" class="tooltip">
 ...
 *  * 6. Etc (생길 시 얘기.)
 *******************************/
import { ref, watch, inject, onBeforeMount, onBeforeUnmount, onUpdated } from 'vue'
 ...
 *******************************/
// const isChrome = /*@cc_on!@*/ false || !document.documentMode
