...
function init() {
  ...
  if (props.propsSearchParam.ramRiskHazardClassCd)
    searchParam.value.ramRiskHazardClassCd = props.propsSearchParam.ramRiskHazardClassCd
