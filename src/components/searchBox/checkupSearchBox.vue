...
function init() {
  ...
  if (props.propsSearchParam.period) {
    searchParam.value.startYmd = props.propsSearchParam.period[0]
    searchParam.value.endYmd = props.propsSearchParam.period[1]
  }
}
/******************************
 * @Provide_선언
