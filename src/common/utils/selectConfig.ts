...
const selectConfig = {
  ...
  ram: {
    ...
    assessJob: {
      list: {
        url: '/api/ram/assess/jobs'
      },
      krasAssessJobList: {
        url: '/api/ram/assess/jobs/kras'
      },
      fmRiskHazardList: {
        url: '/api/ram/assess/job/fmRiskHazards'
      },
      krasRiskHazardList: {
        url: '/api/ram/assess/job/krasRiskHazards'
      }
    },
    kpsr: {
      summary: {
    ...
    kras: {
      ...
      riskHazardStatus: {
        url: '/api/ram/kras/riskHazard/status'
      },
      riskReduce: {
        list: {
    ...
    fm: {
      ...
      riskHazardStatus: {
        url: '/api/ram/4m/riskHazard/status'
      },
      scenario: {
        list: {
  ...
  fft: {
    ...
    fireFightingPerformanceResult: {
      ...
      print: {
        url: '/api/fft/fireFighting/performanceResult/print'
      }
    },
  ...
  swp: {
    workCheck: {
      list: {
        url: '/api/swp/checkItems'
      }
    },
    workPermit: {
      list: {
        url: '/api/swp/workPermits'
      },
      get: {
        url: '/api/swp/workPermit'
      },
      print: {
        url: '/api/swp/workPermit/print/{0}'
      }
    }
  },
  sop: {
    heq: {
      ...
      forkLift: {
        ...
        forkchecks: {
          url: '/api/sop/heq/forkLift/forkchecks'
        }
      },
      hpg: {
        item: {
          list: {
            url: '/api/sop/heq/hpg/checkitems'
          }
        },
        check: {
          list: {
            url: '/api/sop/heq/hpg/checks'
          },
          get: {
            url: '/api/sop/heq/hpg/check'
          }
        }
      }
    },
    ...
    safetycheck: {
      ...
      result: {
        ...
        user: {
          url: '/api/sop/min/smd/safetycheck/result/user'
        }
      },
      improve: {
        get: {
    ...
    mam: {
      ...
      chem: {
        ...
        materialRegul: {
          ...
          history: {
            url: '/api/mdm/mam/chem/materialRegul/histories'
          },
          historyDetail: {
            url: '/api/mdm/mam/chem/materialRegul/historyDetail'
          }
        }
      },
      regulation: {
  ...
  sai: {
    ...
    sse: {
      mst: {
        list: {
          url: '/api/sai/sse/mst/inspectionCheckItems'
        },
        esteam: {
          list: {
            url: '/api/sai/sapa/mst/semi/esteams',
            all: {
              url: '/api/sai/sapa/mst/semi/esteams/all'
            }
          }
        }
      },
      shd: {
        list: {
          url: '/api/sai/sse/inspection/results',
          all: {
            url: '/api/sai/sse/inspection/results/all'
          }
        },
        result: {
          default: {
            url: '/api/sai/sse/inspection/default'
          }
        },
        inpection: {
          get: {
            url: '/api/sai/sse/inspection/{0}'
          }
        }
      },
      es: {
        list: {
          url: '/api/sai/sapa/checks',
          all: {
            url: '/api/sai/sapa/checks/results'
          }
        },
        get: {
          url: '/api/sai/sapa/check/{0}'
        }
      },
      selfEvaluation: {
        list: {
      ...
      supervisor: {
        list: {
          url: 'api/sat/sse/supervisor/appointment'
        },
        get: {
          url: 'api/sat/sse/supervisor/appointment/{0}'
        },
        print: {
          url: 'api/sat/sse/supervisor/appointment/print/{0}'
        },
        mst: {
          item: {
            url: '/api/sai/supervisor/mst/items'
          },
          evaluatee: {
            url: '/api/sai/supervisor/mst/evaluatee',
            nameGet: {
              url: '/api/sai/supervisor/evaluatees/{0}'
            }
          }
        }
      },
      ...
      superInspection: {
        list: {
          url: '/api/sai/supervisor/inspections'
        },
        status: {
          url: '/api/sai/supervisor/inspection/status'
        },
        get: {
          url: '/api/sai/supervisor/inspection/{0}'
        }
      }
    },
    kpi: {
      list: {
        url: '/api/sai/goal/kpis'
      },
      get: {
        url: '/api/sai/goal/kpi'
      }
    }
  },
  hea: {
    ...
    jobStress: {
      ...
      base: {
        ...
        center: {
          list: {
            url: '/api/hea/jss/base/jobStressCenters'
          }
        }
      }
    },
    muscleSystem: {
      ...
      muscleSurvey: {
        ...
        countList: {
          url: '/api/hea/mss/muscleSurvey/count/{0}'
        }
      },
      muscleSopResultImpr: {
        list: {
  ...
  env: {
    ghg: {
      master: {
        list: {
          url: '/api/env/ghg/masters'
        }
      },
      rawFuel: {
        list: {
          url: '/api/env/ghg/rawFuels'
        }
      },
      facility: {
        list: {
          url: '/api/env/ghg/facilities'
        },
        commonList: {
          url: '/api/env/ghg/commonFacilities'
        },
        get: {
          url: '/api/env/ghg/facility/{0}'
        },
        equipment: {
          url: '/api/env/ghg/facility/equipment/{0}'
        }
      },
      factor: {
        list: {
          url: '/api/env/ghg/operate/factors'
        }
      },
      quota: {
        list: {
          url: '/api/env/ghg/operate/quotas'
        }
      },
      amount: {
        list: {
          url: '/api/env/ghg/operate/amounts'
        }
      },
      calculation: {
        list: {
          url: '/api/env/ghg/operate/calculations'
        }
      },
      status: {
        type: {
          list: {
            url: '/api/env/ghg/operate/type/status'
          }
        },
        plant: {
          list: {
            url: '/api/env/ghg/operate/plant/status'
          }
        },
        month: {
          list: {
            url: '/api/env/ghg/operate/month/status'
          }
        }
      }
    },
    ...
    facilitySelfSemiCheckItem: {
      list: {
        url: '/api/env/hcf/facility/selfSemiCheckItems'
      }
    },
    //환경 - 토양
    soil: {
      list: {
        url: '/api/env/soil/soilPollutionMeasureResults'
      },
      get: {
        url: '/api/env/soil/soilPollutionMeasureResult/{0}'
      },
      mst: {
        pollutant: {
          list: {
            url: '/api/env/soil/mst/pollutants'
          }
        }
      },
      ...
      facility: {
        list: {
          url: '/api/env/soil/pollution/facilities'
        },
        get: {
          url: '/api/env/soil/pollution/facility/{0}'
        }
      },
      map: {
        list: {
          url: '/api/env/soil/pollution/facility/maps'
        }
      }
    },
    gov: {
    ...
    water: {
      ...
      daily: {
        result: {
          ...
          check: {
            url: '/api/env/water/daily/result/check'
          }
        },
        resultG14: {
          list: {
            url: '/api/env/water/daily/results/g14'
          },
          get: {
            url: '/api/env/water/daily/result/g14'
          },
          print: {
            url: '/api/env/water/daily/result/g14/print'
          },
          check: {
            url: '/api/env/water/daily/result/g14/check'
          }
        },
        additive: {
          list: {
      ...
      mst: {
        outlet: {
          list: {
            url: '/api/env/water/mst/outlets'
          },
          get: {
            url: '/api/env/water/mst/outlet/{0}'
          }
        },
        preventive: {
          list: {
        ...
        waterManagement: {
          list: {
            url: '/api/env/water/mst/water/managements'
          }
        },
        measureloc: {
          list: {
    ...
    waste: {
      pops: {
        list: {
          url: '/api/env/waste/pops'
        },
        get: {
          url: '/api/env/waste/pops/{0}'
        }
      },
      contract: {
        list: {
          url: '/api/env/waste/contract/{0}'
        }
      },
      mst: {
        list: {
    ...
    air: {
      daily: {
        result: {
          ...
          check: {
            url: '/api/env/air/daily/result/check'
          }
        },
        report: {
          get: {
            url: '/api/env/air/daily/report'
          }
        },
        outlet: {
          list: {
      ...
      mst: {
        outlet: {
          ...
          link: {
            url: '/api/env/air/mst/outlet/link'
          }
        },
        discharge: {
          list: {
          ...
          link: {
            url: '/api/env/air/mst/discharge/link'
          }
        },
        preventive: {
          list: {
          ...
          part: {
            url: '/api/env/air/mst/preventive/parts',
            status: '/api/env/air/mst/preventive/parts/status'
          },
          wattmeter: {
            list: {
              url: '/api/env/air/mst/preventive/wattmeters'
            }
          },
          link: {
            url: '/api/env/air/mst/preventive/link'
          }
        },
        fuel: {
          list: {
        ...
        history: {
          list: {
            url: '/api/env/air/mst/preventive/part/historys'
          },
          get: {
            url: '/api/env/air/mst/preventive/part/history'
          }
        },
        haps: {
          outlets: {
            url: '/api/env/air/haps/outlets'
          },
          emission: {
            url: '/api/env/air/haps/emission'
          },
          emissions: {
            url: '/api/env/air/haps/emissions'
          }
        }
      },
      self: {
      ...
      sems: {
        outletOpertime: {
          list: {
            url: '/api/v2/env/air/sems/outlet/opertimes'
          }
        },
        oprtimes: {
          list: {
        ...
        opertimes: {
          list: {
            url: '/api/v2/env/air/sems/opertimes'
          },
          day: {
            url: '/api/v2/env/air/sems/opertimes/day'
          },
          outlet: {
            url: 'api/v2/env/air/sems/opertimes/outlet'
          }
        },
        dischargeOpertime: {
          list: {
            url: '/api/v2/env/air/sems/discharge/opertimes'
          },
          day: {
            url: '/api/v2/env/air/sems/discharge/opertimes/day'
          }
        },
        preventiveOperation: {
          list: {
            url: '/api/v2/env/air/sems/preventive/operations'
          },
          day: {
            url: '/api/v2/env/air/sems/preventive/operations/day'
          },
          preventive: {
            url: '/api/v2/env/air/sems/preventive/operations/preventive'
          }
        },
        prehis: {
          list: {
        ...
        preventiveMaintenance: {
          list: {
            url: '/api/v2/env/air/sems/preventive/maintenances'
          }
        },
        oprequips: {
          list: {
        ...
        fuelUsage: {
          list: {
            url: '/api/v2/env/air/sems/discharge/fuels'
          }
        },
        materials: {
          list: {
        ...
        materialsUsage: {
          list: {
            url: '/api/v2/env/air/sems/materials'
          },
          get: {
            url: '/api/v2/env/air/sems/material'
          },
          check: {
            url: '/api/v2/env/air/sems/material/check'
          }
        }
      },
      structure: {
        list: {
          url: '/api/env/air/structures'
        },
        get: {
          url: '/api/env/air/structure/{0}'
        }
      },
      tms: {
        check: {
          list: {
            url: '/api/env/tms/checks'
          },
          get: {
            url: '/api/env/tms/check'
          }
        },
        mst: {
          list: {
            url: '/api/env/tms/msts'
          },
          get: {
            url: '/api/env/tms/mst/{0}'
          }
        },
        dl: {
          list: {
        ...
        accuracy: {
          list: {
            url: '/api/env/tms/accuracys'
          },
          get: {
            url: '/api/env/tms/accuracy/{0}'
          }
        },
        card: {
          list: {
            url: '/api/env/tms/cards'
          },
          get: {
            url: '/api/env/tms/card/{0}'
          }
        },
        plan: {
          list: {
            url: '/api/env/tms/plans'
          },
          get: {
            url: '/api/env/tms/plan/{0}',
            default: {
              url: '/api/env/tms/plan/default'
            }
          }
        },
        main: {
          list: {
            url: '/api/env/tms/mstmains'
          },
          get: {
            url: '/api/env/tms/mstmain/{0}'
          }
        }
      },
      haps: {
    ...
    sems: {
      air: {
        self: {
          measure: {
            list: {
              url: '/api/env/sems/air/self/measures'
            },
            sublist: {
              url: '/api/env/sems/air/self/sub/measures'
            },
            get: {
              url: '/api/env/sems/air/self/measure'
            },
            graph: {
              url: '/api/env/sems/air/self/measure/graph'
            }
          }
        }
      }
    ...
    ieps: {
      air: {
        dischargeOpertime: {
          list: {
            url: '/api/env/ieps/discharge/opertimes'
          }
        },
        preventiveOperation: {
          list: {
            url: '/api/env/ieps/air/preventive/operations'
          },
          day: {
            url: '/api/v2/env/air/sems/preventive/operation/day'
          },
          drug: {
            url: '/api/v2/env/air/sems/preventive/operation/day/drug'
          }
        },
        self: {
          measure: {
            list: {
              url: '/api/env/ieps/air/self/measures'
            },
            sublist: {
              url: '/api/env/ieps/air/self/sub/measures'
            },
            get: {
              url: '/api/env/ieps/air/self/measure'
            },
            graph: {
              url: '/api/env/ieps/air/self/measure/graph'
            }
          }
        },
        fuel: {
          list: {
            url: '/api/env/ieps/discharge/fuels'
          }
        }
      },
      water: {
        self: {
          measure: {
            list: {
              url: '/api/env/ieps/water/self/measures'
            },
            sublist: {
              url: '/api/env/ieps/water/self/sub/measures'
            },
            get: {
              url: '/api/env/ieps/water/self/measure'
            },
            graph: {
              url: '/api/env/ieps/water/self/measure/graph'
            },
            history: {
              url: '/api/env/ieps/water/self/sub/measures/date'
            }
          }
        },
        preventive: {
          list: {
            url: '/api/env/ieps/preventive/operations'
          }
        }
      },
      // ieps기준정보
      mst: {
        odor: {
          list: {
            url: '/api/env/odor/mst/pollutants'
          }
        },
        nonPoint: {
          list: {
            url: '/api/env/non/point/mst/pollutants'
          }
        },
        location: {
          list: {
            url: '/api/env/location/mst/pollutants'
          }
        }
      },
      rawAndSub: {
        list: {
          url: '/api/env/ieps/rawAndSub/usage'
        },
        get: {
          url: '/api/env/ieps/rawAndSub/usage/{0}'
        }
      },
      etcChem: {
        list: {
          url: '/api/env/ieps/etcChem/usage'
        },
        detail: {
          url: '/api/env/ieps/etcChem/usage/{0}'
        }
      },
      energy: {
        list: {
          url: '/api/env/ieps/energy/usage'
        },
        detail: {
          url: '/api/env/ieps/energy/usage/{0}'
        }
      },
      product: {
        list: {
          url: '/api/env/ieps/product/volume'
        },
        detail: {
          url: '/api/env/ieps/product/volume/{0}'
        }
      },
      folder: {
        list: {
          url: '/api/env/ieps/folders'
        },
        get: {
          url: '/api/env/ieps/folder/{0}'
        }
      },
      folderDetail: {
        list: {
          url: '/api/env/ieps/folder/details/{0}'
        },
        defaultList: {
          url: '/api/env/ieps/folder/details'
        },
        get: {
          url: '/api/env/ieps/folder/detail/{0}'
        },
        rev: {
          url: '/api/env/ieps/folder/detail/revs',
          get: {
            url: '/api/env/ieps/folder/detail/rev/{0}'
          }
        }
      },
      outlet: {
        list: {
          url: '/api/env/ieps/outlet/opertimes'
        }
      }
    },
    process: {
      list: {
        url: '/api/env/processes'
      },
      get: {
        url: '/api/env/process/{0}'
      },
      check: {
        url: '/api/env/process/check/{0}'
      }
    },
    procWork: {
      list: {
        url: '/api/env/process/workplaces'
      },
      onlyProc: {
        list: {
          url: '/api/env/process/workplace/processes'
        },
        get: {
          url: '/api/env/process/workplace/process/{0}'
        }
      }
    }
  },
  ...
  pe: {
    base: {
      list: {
        url: '/api/pe/base/evaluationItems'
      }
    },
    evaluation: {
      list: {
      ...
      get: {
        url: '/api/performance/evaluation/{0}'
      },
      print: {
        url: '/api/performance/evaluation/print'
      }
    }
  },
  um: {
    userManual: {
      list: {
        url: '/api/um/userManuals'
      },
      get: {
        url: '/api/um/userManual/{0}'
      }
    },
    userManualPdf: {
      get: {
        url: '/api/um/userManualPdf/{0}'
      }
    }
  },
  openApi: {
  ...
  test: {
    safety: {
      resultItem: {
        list: {
          url: '/api/sai/safety/result/items',
          mst: '/api/sai/safety/result/itemsMst'
        }
      },
      list: {
        url: '/api/sai/sfy/safetys'
      },
      get: {
        url: '/api/sai/sfy/safety/{0}'
      },
      graph: {
        result: {
          url: '/api/sai/sfy/safety/graphs/result'
        },
        resultitem: {
          url: '/api/sai/sfy/safety/graphs/resultitem'
        },
        itemresult: {
          url: '/api/sai/sfy/safety/graphs/itemresult'
        }
      }
    }
  }
