...
const transactionConfig = {
  ...
  ram: {
    ...
    assessJob: {
      ...
      delete: {
        url: '/api/ram/assess/job/{0}/{1}/{2}'
      },
      krasDelete: {
        url: '/api/ram/assess/job/kras/{0}/{1}/{2}'
      },
      fmRiskHazardSave: {
        url: '/api/ram/assess/job/fmRiskHazard'
      },
      krasRiskHazardSave: {
        url: '/api/ram/assess/job/krasRiskHazard'
      }
    },
    riskRegister: {
      delete: {
  ...
  swp: {
    ...
    workPermit: {
      ...
      map: {
        insert: {
          url: '/api/swp/workPermit/map'
        },
        update: {
          url: '/api/swp/workPermit/map'
        },
        delete: {
          url: '/api/swp/workPermit/map/{0}'
        }
      }
    }
  },
  sop: {
    ...
    scm: {
      construction: {
        ...
        entry: {
          save: {
            url: '/api/sop/scm/construction/entry'
          }
        }
      }
    },
    ...
    eap: {
      ...
      scenario: {
        ...
        delete: {
          url: '/api/sop/eap/plan/scenario/{0}/{1}'
        }
      },
      relateAccident: {
        insert: {
      ...
      relateEdu: {
        insert: {
          url: '/api/sop/eap/plan/relate/edu'
        },
        delete: {
          url: '/api/sop/eap/plan/relate/edu'
        }
  ...
  mdm: {
    ...
    mam: {
      review: {
        ...
        substance: {
          ...
          save: {
            url: '/api/mdm/mam/chem/review/substances/normal'
          },
          delete: {
            url: '/api/mdm/mam/chem/review/substances'
          }
      ...
      chem: {
        ...
        substance: {
          ...
          save: {
            url: '/api/mdm/mam/chem/substance/normal'
          },
          delete: {
            url: '/api/mdm/mam/chem/substance'
          }
    ...
    sop: {
      ...
      step: {
        ...
        hazardAllDelete: {
          url: '/api/mdm/sop/step/hazard/allDelete'
        }
      },
      hazardFactor: {
        save: {
  ...
  sai: {
    ...
    internal: {
      ...
      result: {
        complete: {
          url: '/api/sai/internal/result/complete'
        }
      },
      targetDept: {
        update: {
    ...
    sse: {
      mst: {
        insert: {
          url: '/api/sai/sse/mst/inspectionCheckItem'
        },
        save: {
          url: '/api/sai/sse/mst/inspectionCheckListItem/bulk'
        },
        delete: {
          url: '/api/sai/sse/mst/inspectionCheckList'
        },
        esteam: {
          save: {
      ...
      shd: {
        insert: {
          url: '/api/sai/sse/inspection/result'
        },
        delete: {
      ...
      supervisor: {
        ...
        mst: {
          item: {
            url: '/api/sai/supervisor/mst/item'
          },
          evaluatee: {
      ...
      superInspection: {
        insert: {
          url: '/api/sai/supervisor/inspection'
        },
        delete: {
  ...
  hea: {
    ...
    jobStress: {
      ...
      base: {
        ...
        center: {
          save: {
            url: '/api/hea/jss/base/jobStressCenter'
          }
        }
      }
    },
    muscleSystem: {
      ...
      muscleHeavyWork: {
        ...
        workerdelete: {
          url: '/api/hea/mss/muscleHeavyWork/worker/{0}/{1}/{2}'
        }
      },
      muscleSopHazard: {
        save: {
  ...
  env: {
    ghg: {
      master: {
        save: {
          url: '/api/env/ghg/master'
        }
      },
      rawFuel: {
        save: {
          url: '/api/env/ghg/rawFuel'
        }
      },
      facility: {
        insert: {
          url: '/api/env/ghg/facility'
        },
        update: {
          url: '/api/env/ghg/facility'
        },
      ...
      factor: {
        save: {
          url: '/api/env/ghg/operate/factor'
        },
        delete: {
          url: '/api/env/ghg/operate/factor'
        }
      ...
      amount: {
        save: {
          url: '/api/env/ghg/operate/amount'
        },
        delete: {
          url: '/api/env/ghg/operate/amount'
        }
    ...
    mst: {
      odor: {
        save: {
          url: '/api/env/odor/mst/pollutant'
        }
      },
      nonPoint: {
        save: {
          url: '/api/env/non/point/mst/pollutant'
        }
      },
      location: {
        save: {
          url: '/api/env/location/mst/pollutant'
        }
      }
    },
    ...
    soil: {
      mst: {
        pollutant: {
          save: {
            url: '/api/env/soil/mst/pollutant'
          }
        }
      },
      save: {
        url: '/api/env/soil/soilPollutionMeasureResult'
      },
      insert: {
        url: '/api/env/soil/soilPollutionMeasureResult'
      },
      ...
      facility: {
        insert: {
          url: '/api/env/soil/pollution/facility'
        },
        update: {
          url: '/api/env/soil/pollution/facility'
        },
      ...
      map: {
        save: {
          url: '/api/env/soil/pollution/facility/map'
        },
        delete: {
          url: '/api/env/soil/pollution/facility/map'
        }
    ...
    facilitySelfSemiCheckItem: {
      save: {
        url: '/api/env/hcf/facility/selfSemiCheckItem'
      }
    },
    gov: {
      mst: {
    ...
    water: {
      ...
      daily: {
        ...
        resultG14: {
          ...
          delete: {
            url: '/api/env/water/daily/result/g14/{envWaterDailyResultG14Id}'
          }
        },
        additive: {
          save: {
      ...
      mst: {
        ...
        waterManagement: {
          save: {
            url: '/api/env/water/mst/water/management'
          }
        },
        measureloc: {
          insert: {
    ...
    air: {
      daily: {
        ...
        report: {
          delete: {
            url: '/api/env/air/daily/report/{0}'
          }
        },
        outlet: {
          save: {
      ...
      mst: {
        ...
        preventive: {
          ...
          part: {
            save: {
              url: '/api/env/air/mst/preventive/part'
            },
            delete: {
              url: '/api/env/air/mst/preventive/part'
            }
      ...
      sems: {
        opertime: {
          save: {
            url: '/api/v2/env/air/sems/opertime'
          },
          delete: {
            url: '/api/v2/env/air/sems/opertime'
          }
        ...
        dischargeOpertime: {
          save: {
            url: '/api/v2/env/air/sems/discharge/opertime'
          },
          delete: {
            url: '/api/v2/env/air/sems/discharge/opertime'
          }
        ...
        preventiveOperation: {
          save: {
            url: '/api/v2/env/air/sems/preventive/operation'
          },
          delete: {
            url: '/api/v2/env/air/sems/preventive/operation'
          }
        ...
        maintenance: {
          save: {
            url: '/api/v2/env/air/sems/preventive/maintenance'
          },
          delete: {
            url: '/api/v2/env/air/sems/preventive/maintenance'
          }
        ...
        fuel: {
          save: {
            url: '/api/v2/env/air/sems/discharge/fuel'
          },
          delete: {
            url: '/api/v2/env/air/sems/discharge/fuel'
          }
        ...
        material: {
          ...
          delete: {
            url: '/api/v2/env/air/sems/material/{0}'
          }
        }
      },
      tms: {
      ...
      air: {
        self: {
          measure: {
            ...
            delete: {
              url: '/api/env/sems/air/self/measure/{0}'
            }
          }
        }
      }
    ...
    ieps: {
      ...
      folderDetail: {
        insert: {
          url: '/api/env/ieps/folder/detail'
        },
        update: {
          url: '/api/env/ieps/folder/detail'
        },
      ...
      air: {
        self: {
          measure: {
            ...
            delete: {
              url: '/api/env/ieps/air/self/measure/{0}'
            }
          }
        }
      },
      water: {
        self: {
          measure: {
            ...
            delete: {
              url: '/api/env/ieps/water/self/measure/{0}'
            }
          }
        }
      }
  ...
  pe: {
    base: {
      save: {
        url: '/api/pe/base/evaluationItem'
      }
    },
    evaluation: {
      save: {
        url: '/api/performance/evaluation'
      },
      delete: {
    ...
    targetDept: {
      save: {
        url: '/api/performance/evaluation/targetDept'
      },
      delete: {
        url: '/api/performance/evaluation/{0}/{1}'
      }
    }
  },
  um: {
  ...
  test: {
    safety: {
      resultItem: {
        insert: {
          url: '/api/sai/safety/result/item',
          mst: '/api/sai/safety/result/itemMst'
        },
        delete: {
          url: '/api/sai/safety/result/item',
          mst: '/api/sai/safety/result/itemMst'
