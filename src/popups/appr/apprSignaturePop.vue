...
const signaturePadData = ref<any>(null)
...
onMounted(() => {
  ...
  signaturePadData.value = signaturePad.value
  signaturePad.value.lockSignaturePad()

  if (props.popupParam.electronSignature) {
    signaturePad.value.fromDataURL(props.popupParam.electronSignature)
  }
})
