...
function init() {
  ...
  // code setting
  getStepItems('MOC_NORMAL_STEP_CD').then((_result: any) => {
    const idx = _.findIndex(_result, { stepperMstCd: 'MS00000015' })
    _result[idx].stepperMstNm = _result[idx - 1].stepperMstNm + ' / ' + _result[idx].stepperMstNm
    _result = _.reject(_result, { stepperMstCd: 'MS00000010' })
