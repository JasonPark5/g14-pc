...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.sop.sas.buy.list.url
  // code setting
  // list setting
  getList()
}
...
function linkClick(row: any) {
  popupOptions.value.title = '신규 보호구 구매신청 상세'
  popupOptions.value.param = { buyRequestId: row ? row.buyRequestId : '' }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./safetyGearBuyRequestDetail.vue`))
  )
