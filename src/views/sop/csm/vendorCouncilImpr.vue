<template>
  <q-form ref="editForm">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <c-card title="협력사 협의체 기본정보" :collapsed="true" class="cardClassDetailInfo">
        <template v-slot:card-detail>
          <div v-if="tabParam.councilTitle" class="col-6">
            <c-label-text title="제목" :value="tabParam.councilTitle" />
          </div>
          <div v-if="tabParam.councilDate" class="col-6">
            <c-label-text title="일자" :value="tabParam.councilDate" />
          </div>
        </template>
      </c-card>
    </div>
...
function addImprImm() {
  ...
  popupOptions.value.param = {
    requestContents: props.tabParam.councilContents,
    relationTableKey: props.tabParam.councilId,
