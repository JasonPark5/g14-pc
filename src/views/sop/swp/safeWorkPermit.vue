  ...
  <div>
    ...
    >
      <template v-slot:table-button>
        <q-btn-group outline>
          <c-btn v-if="editable" label="화기작업 등록" icon="add" @btnClicked="addFire" />
          <c-btn v-if="editable" label="일반작업 등록" icon="add" @btnClicked="addNormal" />
...
function addFire() {
  // 화기 작업등록
  linkClick({ permitTypeCd: 'SPT0000005' })
}
/******************************
 * TODO (목적): 일반 작업허가서 등록
 *******************************/
function addNormal() {
  // 일반 작업등록
  linkClick({ permitTypeCd: 'SPT0000001' })
}
/******************************
 * TODO (목적): 작업허가서 팝업 표시
 * @param (1): 행 정보
