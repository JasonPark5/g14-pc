<template>
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
      <c-card title="중장비작업 상세정보" class="cardClassDetailForm">
        <!-- input-no-padding-bottom -->
        <template v-slot:card-detail>
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <c-field
              ...
              v-model:value="supWork.heavyEquipSafetyCheckUserId"
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <c-field
              ...
              v-model:value="supWork.heavyEquipManageUserId"
              @dataChange="dataChange"
            />
          </div>
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <c-field
              ...
              v-model:value="supWork.heavyEquipDriveUserId"
              @dataChange="dataChange"
            />
          </div>
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <c-text
              ...
              label="신호수"
              name="heavySignalMan"
              v-model:value="supWork.heavySignalMan"
              @dataChange="dataChange"
            />
          </div>
          <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <c-text
              ...
              label="중장비종류"
              name="heavyType"
              v-model:value="supWork.heavyType"
              @dataChange="dataChange"
            />
          </div>
          <!-- <div class="col-12 q-mb-sm line-text-left"> -->
          <!-- <div class="text-caption text-grey">
            감독 : 모든 작업은 장비투입부터 완료 후 철수할 때까지 요청부서와 지원부서와 현장책임자가 감독한다.
          </div> -->
          <!-- </div> -->
          <div class="col-12">
            <c-textarea
              ...
              v-model:value="supWork.heavyEquipDirectorRequirements"
              @dataChange="dataChange"
            />
          </div>
          <div class="col-12">
            <c-textarea
              ...
              v-model:value="supWork.heavyEquipRequireDeptRequirements"
              @dataChange="dataChange"
            />
          </div>
          <div class="col-12">
            <c-textarea
              ...
              v-model:value="supWork.heavyEquipSupportDeptRequirements"
              @dataChange="dataChange"
            />
          </div>
        </template>
