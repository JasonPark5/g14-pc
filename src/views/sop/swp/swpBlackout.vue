  ...
  <div>
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <c-card title="정전작업 상세정보" class="cardClassDetailForm">
          <template v-slot:card-detail>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <c-text
                ...
                v-model:value="supWork.blackoutCircuitBreakerNo"
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <c-text
                ...
                v-model:value="supWork.blackoutCircuitBreaker"
                @dataChange="dataChange"
              />
            </div>
            <div class="col-12 q-mb-sm line-text-center">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <c-field
                ...
                v-model:value="supWork.blackoutElectricBlockUserId"
                @dataChange="dataChange"
              />
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <c-field
                ...
                v-model:value="supWork.blackoutMaintenanceBlockUserId"
                @dataChange="dataChange"
              />
            </div>
            <div class="col-12 q-mb-sm line-text-center">
              <div class="text-caption text-grey">
                {{
                  $language(
                    '전원복구 : 모든 작업이 완료된 후 운전부서의 요청에 의해서만 전원을 복구하여야 한다.'
                  )
                }}
              </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <c-field
                ...
                v-model:value="supWork.blackoutPowerRecoveryRequestUserId"
                @dataChange="dataChange"
              />
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <c-datepicker
                ...
                v-model:value="supWork.blackoutPowerRecoveryTime"
                @dataChange="dataChange"
              />
            </div>
          </template>
