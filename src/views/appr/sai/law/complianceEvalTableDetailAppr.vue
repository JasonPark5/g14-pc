...
} from '@/views/sai/law/evalTable/complianceEvalTable'
 ...
 *******************************/
defineOptions({
  name: 'complianceEvalTableDetailAppr'
})
  ...
  const _items: Array<tabItemsType> = [
    {
      ...
      component: defineAsyncComponent(
        () => import(`@views/sai/law/evalTable/complianceEvalTableInfo.vue`)
      )
    }
  ]
...
const disabled = computed(() => evalTable.value.saiComplianceEvalTableStepCd === 'CETS000005')
...
function init() {
  ...
  // code setting
  // list setting
  getComboItems('QUARTER_CD').then((_result: any) => {
