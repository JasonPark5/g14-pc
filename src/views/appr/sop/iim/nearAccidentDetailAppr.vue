...
import { nearAccidentPopupParamType } from '@/views/sop/iim/near/nearAccident'
...
const addTabItems = ref<any>([
  {
    ...
    component: shallowRef(
      defineAsyncComponent(() => import(`@/views/sop/iim/near/nearCausePrevention.vue`))
    )
  }
])
const tabItems = ref([
  {
    ...
    label: '아차사고 정보',
    component: shallowRef(
      defineAsyncComponent(() => import(`@/views/sop/iim/near/nearRegisterTab.vue`))
    )
  }
])
/******************************
...
const tabHeight = computed(() =>
  props.contentHeight && !isNaN(props.contentHeight) ? props.contentHeight - 10 + 'px' : '550px'
)
/******************************
 * @Watch_선언
 *******************************/
