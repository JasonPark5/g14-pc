  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
      <q-form ref="editForm">
        ...
        <c-upload :attachInfo="attachInfo" :editable="editable && dataeditable" label="첨부파일" />
      </q-form>
    </div>
  </div>
</template>
...
function rowClick(row: any) {
  ...
  $http({
    ...
    saveType.value = 'PUT'
    attachInfo.value.taskKey = row.sysNoticeId
...
function saveCallback(result: any) {
  ...
  if (saveType.value == 'PUT') {
    getList()
    rowClick({ sysNoticeId: result.data.sysNoticeId })
  } else {
    attachInfo.value.taskKey = result.data.sysNoticeId
