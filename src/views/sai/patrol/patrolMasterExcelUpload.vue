<template>
  <div>
    <c-card title="순회점검 점검항목 업로드" class="cardClassDetailForm">
...
interface gridType {
  ...
  data: Array<Array<patrolMasterType>>
...
const excelUploadInfo = ref<gridType>({
  ...
  taskClassCd: 'PATROL_MASTER_UPLOAD', // 엑셀업로드 양식 구분 값
  sheetNum: 0
})
