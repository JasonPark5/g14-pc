 ...
 *******************************/
defineOptions({
  name: 'supervisorLeaderInspection'
})
...
function linkClick(row: any) {
  popupOptions.value.title = '관리감독자(팀장) 평가 상세'
  popupOptions.value.param = {
    saiSuperEvaluationId: row ? row.saiSuperEvaluationId : '',
    type: row ? row.type : 'B'
  }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./supervisorInspectionLeaderInfo.vue`))
  )
