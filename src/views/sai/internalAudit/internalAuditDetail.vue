<template>
  <c-step
    stepperGrpCd="INTERNAL_AUDIT_STEP_CD"
...
const param = computed(() => {
  return {
    ...
    saiInternalActionId: props.popupParam.saiInternalActionId,
...
function currentStep(data: any) {
  ...
  props.popupParam.saiInternalActionId = data.saiInternalActionId
}
function closePopup() {
  emits('closePopup')
}
...
function keySetting(_data: any) {
  props.popupParam.saiInternalActionId = _data
}
function stepClick() {
