...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.hea.jobStress.plan.list.url
  // code setting
  // list setting
  getList()
}
...
function linkClick(row: any) {
  popupOptions.value.title = '직무스트레스 평가결과 상세'
  popupOptions.value.param = { heaJobStressPlanId: row ? row.heaJobStressPlanId : '' }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./jobStressAssessmentResultDetail.vue`))
  )
