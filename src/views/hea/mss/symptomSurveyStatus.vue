      ...
      <template v-slot:search>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
          <c-select
            ...
            label="진행단계"
            v-model:value="searchParam.heaMuscleSurveyStepCd"
          />
        </div>
      </template>
    </c-search-box>
...
function linkClick(row: any) {
  popupOptions.value.title = '근골격계질환 증상조사표 현황'
  popupOptions.value.param = { heaInvestigationPlanId: row.heaInvestigationPlanId }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./symptomSurveyStatusDetail.vue`))
  )
