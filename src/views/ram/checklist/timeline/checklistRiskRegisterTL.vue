...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.ram.checklist.riskReduce.list.url
  // code setting
  // list setting
  getList()
}
...
function openImprPicture(_props: any) {
  ...
  popupOptions.value.param = {
    ...
    sopImprovementIds: _props.row.sopImprovementIds || _props.row.sopImprovementId,
    disabled: true
  }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(
