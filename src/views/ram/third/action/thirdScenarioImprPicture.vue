...
interface propType {
  popupParam: {
    ramThirdAssessScenarioId: stringNull // 평가 일련번호
...
const props = withDefaults(defineProps<propType>(), {
  popupParam: () => {
    return {
      ramThirdAssessScenarioId: '', // 평가 일련번호
      sopImprovementIds: '',
      disabled: false
    }
  }
...
function init() {
  ...
  // url setting
  // code setting
  attachBeforeInfo.value.taskKey = props.popupParam.ramThirdAssessScenarioId
