...
const items = computed(() => {
  return [
    // 평가계획
    {
      title: $language('평가계획'),
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/thirdPlanTL.vue`)),
      param: { disabled: true }
    },
    // 위험성 추정 및 결정
    {
      ...
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/thirdScenarioTL.vue`)),
      param: { disabled: true }
    },
    // 감소대책 계획 및 실행
    {
      ...
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/thirdRiskRegisterTL.vue`)),
      param: { disabled: true }
    }
  ] as any
})
