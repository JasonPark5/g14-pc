...
const items = computed(() => {
  return [
    // 평가계획
    {
      title: $language('평가계획'),
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/kpsrPlanTL.vue`)),
      param: { disabled: true }
    },
    // 위험성 추정 및 결정
    {
      ...
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/kpsrScenarioTL.vue`)),
      param: { disabled: true }
    },
    // 감소대책 계획 및 실행
    {
      ...
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/kpsrRiskRegisterTL.vue`)),
      param: { disabled: true }
    }
  ] as any
})
