...
const gridRisk = ref<any>({
  merge: [
    ...
    { index: 1, colName: 'process' },
    { index: 2, colName: 'processJob' },
    { index: 3, colName: 'processJobStep' }
  ],
  height: '',
  data: [],
  columns: [
...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.ram.jsa.riskRegister.list.url
  // code setting
