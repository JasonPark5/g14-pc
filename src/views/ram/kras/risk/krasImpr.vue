...
const gridImpr = ref<gridType>({
  merge: [
    ...
    { index: 4, colName: 'ramKrasAssessScenarioId' },
    { index: 5, colName: 'ramKrasAssessScenarioId' },
    { index: 6, colName: 'ramKrasAssessScenarioId' },
    { index: 7, colName: 'ramKrasAssessScenarioId' },
    { index: 8, colName: 'ramKrasAssessScenarioId' }
  ],
  columns: [],
  data: [],
  height: '500px'
