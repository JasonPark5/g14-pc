  ...
  return [
    {
      title: $language('평가계획'),
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/krasPlanTL.vue`)),
      param: { disabled: true }
    },
    {
      title: $language('위험성 추정 및 결정'),
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/krasScenarioTL.vue`)),
      param: { disabled: true }
    },
    {
      title: $language('감소대책 계획 및 실행'),
      visible: true,
      component: defineAsyncComponent(() => import(`./timeline/krasRiskRegisterTL.vue`)),
      param: { disabled: true }
    }
  ] as any
})
