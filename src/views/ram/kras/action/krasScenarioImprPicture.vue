...
interface propType {
  popupParam: {
    ramKrasAssessScenarioId: stringNull // 평가 일련번호
...
const props = withDefaults(defineProps<propType>(), {
  popupParam: () => {
    return {
      ramKrasAssessScenarioId: '', // 평가 일련번호
      sopImprovementIds: '',
      disabled: false
    }
  }
...
function init() {
  ...
  // url setting
  // code setting
  attachBeforeInfo.value.taskKey = props.popupParam.ramKrasAssessScenarioId
