<template>
  <div>
    <component :is="ghsComponent" :popupParam="props.popupParam" />
  </div>
</template>
...
// const tab = ref('chemGhsNation')
// const tabItems = ref([
//   {
//     name: 'chemGhsNation',
//     icon: 'groups',
//     label: '1. 구성물질별 GHS 분류데이터 (국가별)',
//     component: () => import(`${'./chemGhsNation.vue'}`)
//   },
//   {
//     name: 'chemGhsResult',
//     icon: 'list',
//     label: '2. 제품 GHS 혼합분류 결과',
//     component: () => import(`${'./chemGhsResult.vue'}`)
//   },
//   {
//     name: 'chemGhsReasonDb',
//     icon: 'list',
//     label: '3. 제품 GHS 분류근거 DB',
//     component: () => import(`${'./chemGhsReasonDb.vue'}`)
//   }
// ])
const ghsComponent = ref(shallowRef(defineAsyncComponent(() => import(`./chemGhsResult.vue`))))
