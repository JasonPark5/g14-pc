...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.ieps.air.self.measure.list.url
  // code setting
  // list setting
  getList()
}
...
function linkClick(row?: any) {
  popupOptions.value.title = 'IEPS 대기 자가측정 상세'
  popupOptions.value.param = {
    envIepsAirSelfMeasureMainId: row ? row.envIepsAirSelfMeasureMainId : ''
  }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./iepsSelfAirMeasureDetail.vue`))
  )
