...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.water.mst.outlet.list.url
  // code setting
  useFlagItems.value = [
...
function detailPopup(result?: waterMasterDataType) {
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./waterOutletDetail.vue`))
  )
  popupOptions.value.title = '수질 배출구 상세'
  popupOptions.value.param = {
    envWaterMstOutletId: result ? result.envWaterMstOutletId : ''
  }
