...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.water.daily.result.list.url
  // code setting
...
function linkClick(row?: any) {
  ...
  popupOptions.value.param = {
    envWaterDailyResultId: row ? row.envWaterDailyResultId : '',
    plantCd: row ? row.plantCd : ''
  }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./dailyWaterReportDetail.vue`))
  )
