...
function init() {
  // role setting
  // url setting
  listUrl.value = selectConfig.env.water.daily.aerationtank.list.url
  saveUrl.value = transactionConfig.env.water.daily.aerationtank.save.url
  // code setting
  // list setting
  getList()
}
