...
const grid = ref<gridType>({
  columns: [
    ...
    {
      required: true,
      name: 'envNonpointPollutantMstName',
      field: 'envNonpointPollutantMstName',
      label: '비점오염물질 물질명',
      style: 'width:200px',
      align: 'center',
      sortable: true,
    ...
    // {
    //   required: true,
    //   name: 'nonpointPollutantUnitCd',
    //   field: 'nonpointPollutantUnitCd',
    //   label: '단위',
    //   align: 'center',
    //   style: 'width: 60px',
    //   sortable: true,
...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.ieps.mst.nonPoint.list.url
  saveUrl.value = transactionConfig.env.mst.nonPoint.save.url
  // code setting
  useFlagItems.value = [
...
function add() {
  grid.value.data?.splice(0, 0, {
    envNonpointPollutantMstId: uid(),
    plantCd: '1000', // 사업장
    envNonpointrPollutantMstNo: '',
    envNonpointPollutantMstName: '',
