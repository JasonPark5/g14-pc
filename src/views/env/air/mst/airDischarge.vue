...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.air.mst.discharge.list.url
  // code setting
  useFlagItems.value = [
...
function linkClick(row: any) {
  ...
  popupOptions.value.param = {
    envAirMstDischargeId: row ? row.envAirMstDischargeId : ''
  }
  popupOptions.value.target = shallowRef(
    defineAsyncComponent(() => import(`./airDischargeDetail.vue`))
  )
