  ...
  const _items: Array<tabItemsType> = [
    {
      ...
      icon: 'info',
      label: '대기 방지시설 기본정보',
      component: defineAsyncComponent(() => import(`./airPreventiveInfo.vue`))
    }
  ]
    ...
    _items.push(
      {
        ...
        icon: 'construction',
        label: '방지시설 부품/이력 관리',
        component: defineAsyncComponent(() => import(`./airPreventivePart.vue`))
      },
      {
        name: 'govScheduleHistory2',
        icon: 'construction',
        label: '방지시설 보수이력',
        component: defineAsyncComponent(() => import(`./airPreventiveHistory.vue`))
      }
    )
  }
  return _items
