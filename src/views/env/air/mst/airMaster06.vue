...
const listUrl = ref('')
const saveUrl = ref(transactionConfig.env.air.mst.material.insert.url)
...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.air.mst.material.list.url
  // code setting
  useFlagItems.value = [
...
function add() {
  grid.value.data?.splice(0, 0, {
    ...
    plantCd: null, // 사업장
    envAirMstMaterialName: '',
    airMaterialUnitCd: null,
    useFlag: 'Y', // 사용여부
