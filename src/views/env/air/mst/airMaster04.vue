      ...
      <template v-slot:search>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
          <c-checkbox
            ...
            label="IEPS 오염물질"
            name="isIeps"
            v-model:value="searchParam.isIeps"
          />
        </div>
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
          <c-checkbox
            ...
            label="SEMS 오염물질"
            name="isSems"
            v-model:value="searchParam.isSems"
          />
        </div>
      </template>
    </c-search-box>
...
const grid = ref<gridType>({
  columns: [
    ...
    {
      name: 'airInspectUnitCd',
      field: 'airInspectUnitCd',
      label: '단위',
      align: 'center',
      style: 'width: 120px',
      sortable: true,
      type: 'select',
      codeGroupCd: 'AIR_INSPECT_UNIT_CD'
    },
    {
      name: 'legalStandard',
      field: 'legalStandard',
...
function init() {
  ...
  // url setting
  listUrl.value = selectConfig.env.air.mst.inspect.list.url
  saveUrl.value = transactionConfig.env.air.mst.inspect.save.url
  // code setting
  useFlagItems.value = [
...
function add() {
  grid.value.data?.splice(0, 0, {
    envAirMstInspectItemId: uid(),
    envAirMstInspectItemName: '',
    inspectItemCd: '',
    airInspectTypeCd: null,
    airInspectUnitCd: null,
    legalStandard: '',
    useFlag: 'Y', // 사용여부
